...
/**
 * A mediator variable is a name-value or name-expression pair which could be supplied for certain mediators.
 * If expressions are supplied they are evaluated at the runtime against the current message into literal String values.
 */
public class MediatorVariable {

    public static final QName VARIABLE_Q = new QName(XMLConfigConstants.SYNAPSE_NAMESPACE, "variable");
